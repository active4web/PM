			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?= lang("email_list");?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?= lang("email_list");?>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										$current_date=date("Y-m-d H:i");
											...
											$view=$data->view	;
												switch($view){
													case 0:
												$view="<span class='label label-sm label-danger' style='background-color:#e7505a !important'>$noactive</span>";
													  break;
													case 1:
				...
				<a  data-id="<?php echo $data->id;?>" class="btn btn-xs purple table-icon edit" title="change status" style="padding: 1px 0px;">
												...
												<td>
													<div class="btn-group">
														...
														<li><a href="<?=$url?>admin/emails/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> <?= lang("update");?> </a></li>
														
															<li><a href="<?=$url?>admin/emails/delete?id=<?=$data->id;?>"><i class="fa fa-remove"></i> <?= lang("delete");?> </a></li>
