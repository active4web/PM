...
$(document).ready(function(e) {
	...
	$(".my_monthly_tasks").click(function(e) {
        ...
        window.location.assign("<?= DIR?>admin/task/user_tasks_type?monthly=true&user_id="+<?=$this->input->get('user_id');?>+"&type=3&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".button_new").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/user_tasks_type?monthly=true&user_id="+<?=$this->input->get('user_id');?>+"&type=1&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".type_current").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/user_tasks_type?monthly=true&user_id="+<?=$this->input->get('user_id');?>+"&type=1&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".button_other").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/user_tasks_type?monthly=true&user_id="+<?=$this->input->get('user_id');?>+"&type=2&id_project="+<?=$this->input->get('id_project');?>);
    });
