...
$(document).ready(function(e) {
	...
	$(".waitbutton").click(function(e) {
        ...
        window.location.assign("<?= DIR?>admin/task/monthly_tasks?task_type="+<?=$this->input->get('type');?>+"&id_project="+<?=$this->input->get('id_project');?>);
    });
        ...
        window.location.assign("<?= DIR?>admin/task/status_task?task_type="+<?=$this->input->get('type');?>+"&task_status=2&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".button_new_status").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/status_task?task_type="+<?=$this->input->get('type');?>+"&task_status=1&id_project="+<?=$this->input->get('id_project');?>);
    });
