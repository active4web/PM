							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										$main_data=$this->db->get_where("tbl_tasks",array('project_id'=>$id_projects,'real_date>='=>date("Y-m-01"),'real_date<='=>date("Y-m-t"),'status'=>'2'))->result();
											}
											else {
										$main_data=$this->db->get_where("tbl_tasks",array('project_id'=>$id_projects,'user_id'=>$user_id,'real_date>='=>date("Y-m-01"),'real_date<='=>date("Y-m-t"),'status'=>'2'))->result();
											}
...
$(document).ready(function(e) {
	...
	$(".waitbutton").click(function(e) {
        ...
        window.location.assign("<?= DIR?>admin/task/tasks_type?monthly=true&type=3&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".button_new").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/tasks_type?monthly=true&type=1&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".type_current").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/tasks_type?monthly=true&type=1&id_project="+<?=$this->input->get('id_project');?>);
    });
        	$(".button_other").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/tasks_type?monthly=true&type=2&id_project="+<?=$this->input->get('id_project');?>);
    });
