...
$(document).ready(function(e) {
	...
	$(".my_monthly_tasks").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/user_monthly_tasks?task_type="+<?=$this->input->get('type');?>+"&user_id="+<?=$this->input->get('user_id');?>+"&id_project="+<?=$this->input->get('id_project');?>);
    });
        ...
        window.location.assign("<?= DIR?>admin/task/user_status_task?user_id="+<?=$this->input->get('user_id');?>+"&type_task="+<?=$this->input->get('type');?>+"&status_task=2&id_project="+<?=$this->input->get('id_project');?>);
    });
    	$(".button_new_status").click(function(e) {
        window.location.assign("<?= DIR?>admin/task/user_status_task?user_id="+<?=$this->input->get('user_id');?>+"&type_task="+<?=$this->input->get('type');?>+"&status_task=1&id_project="+<?=$this->input->get('id_project');?>);
    });
