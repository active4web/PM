			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?=lang("fproject");?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?=lang("fproject");?></span>
									</div>
								</div>
											...
											<td> <?=$user_name."".$user_lname;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														?>
														<li><a href="<?=$url?>admin/projects/edit?project_id=4&id=<?=$data->id;?>"><i class="fa fa-pencil"></i> <?= lang("update");?> </a></li>
														<?php
														}
													 if($data->status!=4) {
														...
														?>
															<li>
															    <a class="deletebutton"><i class="fa fa-remove"></i> <?= lang("delete");?> </a>
														...
														?>
														<li><a href="<?=$url?>admin/projects/project_status?project_id=4&id_projects=<?=$data->id;?>"><i class="fa fa-pencil"></i>  <?= lang("status");?>   </a></li>
														<?php 
														}
