...
$main_data=$this->db->get_where("users_projects",array('id_projects'=>$this->input->get("id_project")))->result();
}
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/projects/delete_user" method="POST" id="form">
									    <input type="hidden" vale="<?= $this->input->get("id_project");?>" name="id_project">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
										 ...
										 if(count($tt)>0){
											...
											$sname=get_table_filed("tbl_users",array("id"=>$user_id),"sname");
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/projects/delete_user?id_project=<?= $this->input->get("id_project");?>&id_team=<?= $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_teamwork?id_project="+<?= $this->input->get("id_project");?>);
    });
});
</script>
