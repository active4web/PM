...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									...
									<?php if($this->session->userdata('teamwork_project')=="teamwork_project"){	?>
												<td><a href="<?=DIR?>admin/projects/teamwork?id_project=<?=$data->id;?>"><i class="fa fa-users"></i></a></td>
												<?php  } ?>
												<td>
													<div class="btn-group">
	...
	<!--<li><a href="<?=$url?>admin/projects/project_users?id_project=<?=$data->id;?>"><i class="fa fa-users"></i> فريق العمل </a></li>-->
									...
									<center><span class="caption-subject font-red bold uppercase"><?= lang("nodate");?></span></center>
									<?php }?>
								<div class="row">
