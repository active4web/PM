			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							<a href="<?=$url.'admin';?>"><?=lang("home");?></a>
							<i class="fa fa-circle"></i>
						</li>
						
						<li>
							<span class="active"><?=lang("cproject");?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"> <?=lang("cproject");?></span>
									</div>
								</div>
										...
										<div class="row">
											<div class="col-md-12">
												<?php if($result_amount>0){
													...
													?>
													<div class="btn-group">
														<button id="sample_editable_1_2_new" class="btn sbold red delbutton_project">  <?= lang("add");?> 
												...
												<?php 
													...
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> <?= lang("delete");?> 
          ...
          foreach($current_myproject as $data)
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$data->code;?> </td>
												<td><a href="<?=DIR?>admin/task/tasks?id_project=<?=$data->id;?>"> <?= mb_substr($data->name,0,20);?> </a></td>
												<td> <?=$status;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														?>
														<li><a href="<?=$url?>admin/projects/edit?project_id=2&id=<?=$data->id;?>"><i class="fa fa-pencil"></i> <?= lang("update");?> </a></li>
														<?php
														}
													 if($data->status!=4) {
														...
														if($this->session->userdata('projects_delete')=="projects_delete"){
														?>
															<li><a href="<?=$url?>admin/projects/delete?project_id=2&id_projects=<?=$data->id;?>"><i class="fa fa-remove"></i> <?= lang("delete");?> </a></li>
														<?php 
														}
														}
														if($this->session->userdata('project_status')=="project_status"){
														?>
														<li><a href="<?=$url?>admin/projects/project_status?project_id=2&id_projects=<?=$data->id;?>"><i class="fa fa-pencil"></i> <?= lang("status");?> </a></li>
														<?php 
														}
