			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?= lang("endproject");?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?= lang("endproject");?></span>
									</div>
								</div>
											...
											<tr class="odd gradeX">
												...
												<td>
													<div class="btn-group">
														...
														?>
														<li><a href="<?=$url?>admin/projects/edit?project_id=3&id=<?=$data->id;?>"><i class="fa fa-pencil"></i> <?= lang("update");?> </a></li>
														<?php
														}
													 	if($this->session->userdata('projects_delete')=="projects_delete"){
														?>
															<li><a href="<?=$url?>admin/projects/delete?project_id=3&id_projects=<?=$data->id;?>"><i class="fa fa-remove"></i> <?= lang("delete");?> </a></li>
														<?php 
													    }
														if($this->session->userdata('project_status')=="project_status"){
														?>
														<li><a href="<?=$url?>admin/projects/project_status?project_id=3&id_projects=<?=$data->id;?>"><i class="fa fa-pencil"></i>  <?= lang("status");?> </a></li>
														<?php 
														}
