                                                    ...
                                                    <div class="form-body">
														...
														<div class="col-md-3" style="text-align:center"></div>
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																				<img src="<?=$url;?>uploads/site_setting/no_img.png" alt="" /> </div>
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block"><?=lang('username');?></span>
                                                                <input type="text" placeholder="<?=lang('username');?>" class="form-control" name="username">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block"><?=lang('first_name');?></span>
                                                                <input type="text" placeholder="<?=lang('first_name');?>" class="form-control" name="fname">
                                                     ...
                                                     <div class="form-group">
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block"><?=lang('second_name');?></span>
                                                                <input type="text" placeholder="<?=lang('second_name');?>" class="form-control" name="lname">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="caption-subject font-red bold uppercase"><input type="text" placeholder="<?=lang('phone');?>" class="form-control" name="phone" >
                                                                <!--<span class="help-block"> This is inline help </span>-->
															</div>
															<div class="col-md-2"></div>
                                                        </div>
