			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?= lang("permissions");?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?= lang("permissions");?></span>
									</div>
								</div>
									...
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold red cancel"> <?= lang("delete");?>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td><?=$data->name;?></td>
												<td><a href="<?=DIR?>admin/teamwork/edit_permission?id=<?= $data->id?>"><?= lang("permissions");?></a></td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/teamwork/delete_permission?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('delete');?> </a></li>
