									...
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold red cancel_teamwork"> <?= lang("delete");?>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										 ...
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												$dep_name=get_table_filed("services_type",array("id"=>$dep_id),"name");
													$job_description_eng=get_table_filed("tbl_user_groups",array("id"=>$group_id),"name_eng");
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$email;?> </td>
												<td><?=$email_send;?> </td>
												<td><?php if($lang == 'arabic'){ echo $job_description ;?><?php } else {?><?= $job_description_eng; ?><?php }?></td>
												<td> <?=$dep_name;?> </td>
												<td><?=$last_login;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<li><a title="view image" class="example-image-link" href="<?php echo $img;?>" data-lightbox="example-1"><i class="fa fa-picture-o"></i><?= lang("img");?></a></li>
															<li><a href="<?php echo base_url()?>admin/teamwork/update_teamwork?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('update');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/teamwork/password_teamwork?id_type=<?php echo $data->id;?>"><i class="fa fa-key"></i> <?= lang("edit_password");?>  </a></li>
															<li><a href="<?php echo base_url()?>admin/teamwork/delete_teamwork?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('delete');?> </a></li>
